...
Initially 15 images are downloaded from kaggle db for sandbox. This is done in FastAPI in bootup and runs in background. It skips the download step if files are there. It assumes you have OpenAI and Kaggle key and Ollama downloaded and running in local and not in docker. Download Ollama model llama3.2-vision. It first calls Ollama and fallback is OpenAI. OpenAI model testing TBD.
